...
export default function AboutPage() {
  return (
    <main className={styles.page}>
      {/* Section 1: About Someplace Social */}
      <section className={styles.heroSection}>
        <div className={styles.heroText}>
          <h1 style={{ fontSize: '3em', marginBottom: '1rem' }}>About Someplace Social</h1>
      ...
      {/* Section 2: About The Guides */}
      <section className={styles.heroSection} style={{flexDirection: 'row-reverse'}}>
        <div className={styles.heroText}>
          <h2 style={{ fontSize: '2.5em', marginBottom: '1rem' }}>About The Guides</h2>
          <p>We are inherently social creatures. However, modern life can sometimes lead to isolation. The solution is actually super fun: More clubs, classes, art, and parties. We can leverage technology to find existing communities, encourage new spaces, and go someplace social.</p>
        </div>
        <div className={styles.illustrationContainer}>
      ...
      {/* Section 3: Content Box with Details */}
      <section className={styles.contentBox}>
        <h3 style={{ fontSize: '1.8em', marginBottom: '1rem' }}>Why Our Listings Are Different</h3>
        <ul>
        ...
        <h3 style={{ fontSize: '1.8em', marginBottom: '1rem' }}>Event Listings Criteria</h3>
        <ul>
